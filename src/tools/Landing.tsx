    ...
    <div class="min-h-screen flex flex-col items-center justify-center py-16 px-4">
      <div class="relative text-center mb-12 animate-breathe">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse, #6366f1 0%, #8b5cf6 50%, transparent 70%)' }}
        />
        <h1
          class="text-4xl font-bold mb-3"
          style={{ background: 'linear-gradient(to right, #6366f1, #8b5cf6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}
        >
          Web Tools
        </h1>
